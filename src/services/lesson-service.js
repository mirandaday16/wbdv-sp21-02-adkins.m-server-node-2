const LESSONS_FOR_MODULE_URL = 'https://wbdv-generic-server.herokuapp.com/api/YOUR_NEUID/modules/MODULE_ID/lessons';
const LESSONS_URL = 'https://wbdv-generic-server.herokuapp.com/api/YOUR_NEUID/lessons/LESSON_ID';
