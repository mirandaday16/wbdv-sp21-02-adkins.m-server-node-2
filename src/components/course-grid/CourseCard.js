                ...
                <div className="card-body">
                    <h5 className="mda-h3">
                        ...
                        {editing && <input
                            ...
                            value={newTitle}
                            className="form-control"/>}                        <i onClick={() => deleteCourse(course)} className="fas mda-padded-icon mda-clickable-icon fa-trash float-right"></i>
                        {editing && <i onClick={() => saveTitle()} className="fas mda-padded-icon mda-clickable-icon fa-check float-right"></i>}
                        {!editing && <i onClick={() => setEditing(true)} className="fas mda-padded-icon mda-clickable-icon fa-edit float-right"></i>}
                    </h5>
